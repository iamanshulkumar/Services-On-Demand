...
@section('page-meta-data')
    {!!  render_page_meta_data_for_service($service_details_for_book) !!}
@endsection
@section('inner-title')
    {{ $service_details_for_book->title}}
@endsection
                                            ...
                                            <div class="overview-summery-contents">
                                                ...
                                                <div class="btn-wrapper">
                                                    @if($service_details_for_book->is_service_online == 1)
                                                        ...
                                                        <button type="submit" class="cmn-btn btn-appoinment btn-bg-1 pay_and_confirm_order">{{ get_static_option('service_order_confirm_title') ?? __('Pay & Confirm Your Order') }} </button>
                                                        @else
