                                ...
                                <div class="append-additional-includes">
                                    ...
                                    <div class="single-dashboard-input what-include-element">
                                        ...
                                        <div class="single-info-input margin-top-20">
                                            ...
                                            <input class="form--control" type="text" name="include_service_title[]" placeholder="<?php echo e(__('Service tilte')); ?>" value="<?php echo e($include->include_service_title); ?>">
                                        </div>
                                ...
                                <div class="single-settings online_service_price_show_hide">
                                    <div class="single-dashboard-input">
                                        <div class="single-info-input margin-top-20">
                                            ...
                                            <input class="form--control" type="number" value="<?php echo e($service->online_service_price); ?>"  step="0.01" name="online_service_price" placeholder="<?php echo e(__('Service price')); ?>">
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                                    ...
                                    <div class="append-additional-services">
                                        <?php $__currentLoopData = $service_additionals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $additional): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                            <div class="single-dashboard-input additional-services">
                                                ...
                                                <div class="single-info-input margin-top-20">
                                                    <label><?php echo e(__('Title')); ?></label>
                                                    <input class="form--control" type="text" name="additional_service_title[]" placeholder="<?php echo e(__('Service tilte')); ?>"  value="<?php echo e($additional->additional_service_title); ?>">
                                                </div>
                                                <div class="single-info-input margin-top-20">
                                                    <label><?php echo e(__('Unit Price')); ?></label>
                                    ...
                                    <div class="append-faqs">
                                        <?php $__currentLoopData = $online_service_faq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="single-dashboard-input benifits">
                                                ...
                                                <div class="single-info-input margin-top-20">
                                                    <textarea class="form--control" name="faqs_description[]" placeholder="<?php echo e(__('Faq Descriptiom')); ?>"><?php echo e($faq->description); ?></textarea>
                                                </div>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Maverick\Work\Website\XAMPP_v2\htdocs\services-on-demand\@core\resources\views/frontend/user/seller/services/edit-service-attributes.blade.php ENDPATH**/ ?>