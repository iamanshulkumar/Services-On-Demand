                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="dashboard-order-single margin-top-40">
                                ...
                                <div class="single-oreder-request">
                                    ...
                                    <span class="orders"><?php echo e(Carbon\Carbon::parse($order->date)->format('d/m/y')); ?></span>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Maverick\Work\Website\XAMPP_v2\htdocs\services-on-demand\@core\resources\views/frontend/user/seller/order/pending-orders.blade.php ENDPATH**/ ?>