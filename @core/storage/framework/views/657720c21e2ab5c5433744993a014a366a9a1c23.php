                ...
                <ul class="metismenu" id="menu">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('public-chat')): ?>
                        <?php if(moduleExists("LiveChat")): ?>
                            <li class="<?php echo e(active_menu('admin-home/seller')); ?>">
                                <?php if(\Route::has('admin.chat.seller')): ?>
                                <a href="<?php echo e(route('admin.chat.seller')); ?>" aria-expanded="true">
                                    <i class="ti-dashboard"></i>
...
<?php /**PATH C:\Maverick\Work\Website\XAMPP_v2\htdocs\services-on-demand\@core\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>