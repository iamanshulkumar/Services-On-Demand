...
<div class="page-container">
    ...
    <footer>
        <div class="footer-area footer-wrap">
            ...
            <p class="version">V-<?php echo e(get_static_option('site_script_version','1.3.0')); ?></p>
        </div>
    </footer>
</div>
...
<?php /**PATH C:\Maverick\Work\Website\XAMPP_v2\htdocs\services-on-demand\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>