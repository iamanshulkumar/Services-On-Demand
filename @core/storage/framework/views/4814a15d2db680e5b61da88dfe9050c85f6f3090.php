<?php if(Auth::guard('web')->check() && Auth::guard('web')->user()->user_type === 1): ?>
                                ...
                                <div class="conversation-start">
                                        <div class="chat-showing-person">
                                            ...
                                            <div class="col-item-4-form-style">
                                                ...
                                                <small class="please_login_text"><?php echo e('Please login to start chat with seller'); ?></small>
    ...
    <?php endif; ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/@core/Modules/LiveChat/Resources/views/components/widget-markup.blade.php ENDPATH**/ ?>