...
<?php endif; ?> </div>
                                    ...
                                    <div class="single-settings">
                                        ...
                                        <div class="single-dashboard-input">
                                            <div class="single-info-input margin-top-30">
                                                ...
                                                <textarea class="form--control textarea--form account_detactive_description" name="description" id="description" placeholder="<?php echo e(__('Describe Your Reason')); ?>"></textarea>
                                            </div>
                                        </div>
                                        <div class="btn-wrapper margin-top-40">
    ...
    <!-- Dashboard area end -->
    <?php $__env->stopSection(); ?>   
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Maverick\Work\Website\XAMPP_v2\htdocs\services-on-demand\@core\resources\views/frontend/user/seller/profile/seller-account-settings.blade.php ENDPATH**/ ?>