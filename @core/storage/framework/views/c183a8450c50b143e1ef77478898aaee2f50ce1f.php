                                ...
                                <?php $__currentLoopData = $reports; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p><strong><?php echo e(__('Report Data:')); ?></strong> <?php echo e(date('d-m-Y', strtotime($data->created_at))); ?></p>
                                            <p><strong><?php echo e(__('Description:')); ?></strong> <span class="btn btn-info report_description" data-toggle="modal" data-target="#reportModal" data-report="<?php echo e($data->report); ?>"><i class="ti-eye"></i></span></p>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <!--<a class="btn btn-info mb-3" href="<?php echo e(route('admin.orders.details',$data->id)); ?>" data-toggle="tooltip" title="View Order Details"><i class="ti-eye"></i></a>-->
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Maverick\Work\Website\XAMPP_v2\htdocs\services-on-demand\@core\resources\views/backend/pages/orders/seller-buyer-report.blade.php ENDPATH**/ ?>