    ...
    {   
        if($request->isMethod('post')){
            ...
            if($user ){
                ...
                try {
                    $message_body = __('You have successfully registered as a '). $user_type.'</br>'.'<span class="verify-code">'.__('Your account infos--- ').'</br>' .__('Username: ').$request->username. '</br>'.__(' Email: ').$request->email. '</br>'.__(' Verification Code: ').$email_verify_tokn.'</span>';
